   ...
   <form action="" method="POST" enctype="">
     <div class="input-group mb-3">
       ...
       <input type="text" class="form-control <?= !empty($errors['name']) ? 'border-danger' : '' ?>"
         placeholder="Enter name" aria-label="Username" name="name" autofocus value="<?= setValue('name') ?>">
     ...
     <div class="input-group mb-3">
       ...
       <input type="text" class="form-control <?= !empty($errors['username']) ? 'border-danger' : '' ?>"
         placeholder="Enter username" aria-label="Username" name="username" value="<?= setValue('username') ?>">
     ...
     <div class="input-group mb-3">
       ...
       <input type="email" class="form-control <?= !empty($errors['email']) ? 'border-danger' : '' ?>"
         placeholder="Enter email address" aria-label="Email" name="email" value="<?= setValue('email') ?>">
     ...
     <div class="input-group mb-3">
       ...
       <input type="password" class="form-control <?= !empty($errors['repeat_pwd']) ? 'border-danger' : '' ?>"
         placeholder="Repeat password" aria-label="Password" name="repeat_pwd" value="<?= setValue('repeat_pwd') ?>">
