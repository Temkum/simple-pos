   ...
   <div class="d-flex">
     <div class="bg-gray shadow-sm col-md-8 col-lg-6 me-3">
       <div class="input-group mb-3 w-75 p-2">
         ...
         <input onkeyup="checkForEnterKey(event)" type="text" class="form-control js-search" placeholder="Search" aria-label="" oninput="searchItem(event)">
 ...
 <div class="modals hide js-paid-amt" onclick="hideModal(event, 'amount_paid')" role="close-button">
   <div class="modal-box js-modal">
     ...
     <h5 class="bold">Checkout <i class="btn float-end btn-outline-lg bi bi-x-lg" onclick="hideModal(event, 'amount_paid')" role="close-button"></i></h5>
     <br>
     <input onkeyup="if(event.keyCode == 13) validateAmountPaid(event)" type="number" id="js_change" class="form-control mb-2 js-cash-input" placeholder="Enter amount paid">
     <br>
 ...
 <div class="modals hide js-change" onclick="hideModal(event, 'change')" role="close-button">
   <div class="modal-box js-modal">
     <h5 class="bold">Change <i class="btn float-end btn-outline-lg bi bi-x-lg" onclick="hideModal(event, 'change')" role="close-button"></i></h5>
     <br>
     <div class="js-change-input text-center form-control font-4"></div>
     <br>
     <center>
       <button class="js-close-btn btn btn-secondary btn-lg" onclick="validateAmountPaid(event)" role="close-button">Continue</button>
     </center>
   </div>
 </div>
