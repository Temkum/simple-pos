...
?>
     ...
     <div class="d-flex">
         <div class="bg-gray shadow-sm col-md-8 col-lg-6 me-3">
             <div class="input-group mb-3 w-75 p-2">
                 ...
                 <input onkeyup="checkForEnterKey(event)" type="text" class="form-control js-search"
                     placeholder="Search" aria-label="" oninput="searchItem(event)">
 ...
 <div class="modals hide js-paid-amt" onclick="hideModal(event, 'amount_paid')" role="close-button">
     <div class="modal-box js-modal">
         ...
         <br>
         <input onkeyup="if(event.keyCode == 13) validateAmountPaid(event)" type="number" id="js_change"
